...
/**
 * @copyright 中荣恒科技有限公司
 * @function 放滑动菜品类的自定义TextView，
 * @author 吴强
 * @version v1.1
 * @date 2015-02-04
 */
public class MenuCategoryTextView extends TextView {
	...
	public MenuCategoryTextView(Context context) {
		super(context);
		init(context);
	}

	public MenuCategoryTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public MenuCategoryTextView(Context context, AttributeSet attrs, int defStyle) {
