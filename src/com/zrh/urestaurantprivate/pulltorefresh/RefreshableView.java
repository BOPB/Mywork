package com.zrh.urestaurantprivate.pulltorefresh;

import com.zrh.urestaurantprivate.umenu.R;
import com.zrh.urestaurantprivate.umenu.R.id;
import com.zrh.urestaurantprivate.umenu.R.layout;
import com.zrh.urestaurantprivate.umenu.R.string;
...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed && !loadOnce) {
			...
			Log.e("Test", "onLayout  is  running");
			Log.e("Test", "onLayout  is  running" + "  " + gridview.getId());
	...
	/**
	 * 当GridView被触摸时调用，其中处理了各种下拉刷新的具体逻辑。
	 */
	@Override
		...
		if (ableToPull) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (currentStatus != STATUS_REFRESHING) {
					...
					headerLayoutParams.topMargin = (distance / 3)
							+ hideHeaderHeight;
		...
		if (firstChild != null) {
			...
			if (firstVisiblePos == 0 && firstChild.getTop() == 0) {
				...
				if (headerLayoutParams.topMargin != hideHeaderHeight) {
					...
					header.setLayoutParams(headerLayoutParams);
					Log.e("Test",
							"headerLayoutParams.topMargin != hideHeaderHeight  is  running");
				}
